...
import { scaleService, getCurrentReplicas, displayRunningContainers,reloadNginx } from '../utils/dockerHelpers.mjs';
...
export async function scaleDockerService(action) {
  ...
  try {
    ...
    console.log('----> Reloading Nginx to update upstream servers...');
    await reloadNginx();
